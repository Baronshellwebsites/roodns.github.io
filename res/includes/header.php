...
<head>
	...
	<script>$(document).ready(function()
	{
		...
		$('.btl1').click(function(){window.location.href='../ris/mi_rod.php#landscape'});
		$('.btl2').click(function(){window.location.href='../ris/mi_rod.php#landscape2'});		
	...
	<header>
		...
		<div class="container">
		    ...
		    <ul id='headlist'>
		        ...
		        <li>
		        	<div class="subnav">
				       <a  href="../ris/risindex.php">Родители и Семья</a>		        	    
		               <div class="subnav-content"><br><br>
		                   <a href="../ris/mi_rod.php">Мы-родители</a>
		                   <a href="../ris/steps.php">Шаги</a>
		                   <a href="../ris/comm.php">Сообщество</a>
		               </div>
		            </div>
        		</li>
		    	...
		    	<li>
		    		<div class="subnav">
				       <a href="res.php">Источники</a>
		               <div class="subnav-content"><br><br>
		                   <a href="freq.php">Частые вопросы</a>
		               </div>
		            </div>		    		
		    	</li>
